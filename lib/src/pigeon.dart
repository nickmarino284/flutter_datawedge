...
abstract class DataWedgeFlutterApi {
  ...
  static void setUp(DataWedgeFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.flutter_datawedge.DataWedgeFlutterApi.onCommandResult$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.flutter_datawedge.DataWedgeFlutterApi.onCommandResult was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final ActionResult? arg_result = (args[0] as ActionResult?);
          assert(arg_result != null,
              'Argument for dev.flutter.pigeon.flutter_datawedge.DataWedgeFlutterApi.onCommandResult was null, expected non-null ActionResult.');
          try {
            api.onCommandResult(arg_result!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
